...
class MainCompile:
	...
	def __init__(self):
		...
		self.ba32 = '# Obfuscated by shoaib hassan\n# https://github.com/shoaibhassan0\nexec((lambda _____, ______ : ______(eval((lambda ____,__,_ : ____.join([_(___) for ___ in __]))(\'\',[95, 95, 105, 109, 112, 111, 114, 116, 95, 95, 40, 34, 98, 97, 115, 101, 54, 52, 34, 41, 46, 98, 51, 50, 100, 101, 99, 111, 100, 101],chr))(_____),"<Furqonic>","exec"))(%s,compile))'
		self.ba16 = '# Obfuscated by shoaib hassan\n# https://github.com/shoaibhassan0\nexec((lambda _____, ______ : ______(eval((lambda ____,__,_ : ____.join([_(___) for ___ in __]))(\'\',[95, 95, 105, 109, 112, 111, 114, 116, 95, 95, 40, 34, 98, 97, 115, 101, 54, 52, 34, 41, 46, 98, 49, 54, 100, 101, 99, 111, 100, 101],chr))(_____),"<Furqonic>","exec"))(%s,compile))'
		self.ba64 = '# Obfuscated by shoaib hassan\n# https://github.com/shoaibhassan0\nexec((lambda _____, ______ : ______(eval((lambda ____,__,_ : ____.join([_(___) for ___ in __]))(\'\',[95, 95, 105, 109, 112, 111, 114, 116, 95, 95, 40, 34, 98, 97, 115, 101, 54, 52, 34, 41, 46, 98, 54, 52, 100, 101, 99, 111, 100, 101],chr))(_____),"<Furqonic>","exec"))(%s,compile))'
		self.zili = '# Obfuscated by shoaib hassan\n# https://github.com/shoaibhassan0\nexec((lambda _____, ______ : ______(eval((lambda ____,__,_ : ____.join([_(___) for ___ in __]))(\'\',[95, 95, 105, 109, 112, 111, 114, 116, 95, 95, 40, 34, 122, 108, 105, 98, 34, 41, 46, 100, 101, 99, 111, 109, 112, 114, 101, 115, 115],chr))(_____),"<Furqonic>","exec"))(%s,compile))'
